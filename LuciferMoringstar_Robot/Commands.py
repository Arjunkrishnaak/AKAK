    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=message.from_user.id,
                    text="**First Join the channel and try again to get file 👇!**",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("📢 Click here to Join Channel 📢", url=invite_link.invite_link)
                            ],
                            [
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                ...
                InlineKeyboardButton("Help For you", callback_data="help"),
